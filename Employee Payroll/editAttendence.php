    ...
    session_start();
        ...
        $result=mysql_query($query,$con);
           ...
           if(isset($_POST['btnUpdate']))
           {
            ...
            $query="INSERT INTO Attendence(ID,FirstName,LastName,Department,Username,Month,Year,AttendedDays,TotalDays,Percentage) VALUES('$id','$name','$surname','$dept','$username','$month','$year','$attended','$total','$attPer')";
...
<html>
    ...
    <form  method="POST"  style="border:1px solid #ccc">
                    <div class="container">
                      <h1>Update Employee Monthly Attendence</h1>
